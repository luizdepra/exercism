...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    extra_rate = exchange_rate * spread / 100
    return (
        get_number_of_bills(
            exchange_money(budget, exchange_rate + extra_rate), denomination
        )
        * denomination
    )
...
def non_exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    extra_rate = exchange_rate * spread / 100
    return int(exchange_money(budget, exchange_rate + extra_rate)) % denomination
